...
import androidx.compose.ui.unit.dp
import android.zero.studio.ui.colorpicker.ui.gradientColorScaleHSVReversed
import android.zero.studio.ui.colorpicker.util.calculateAngleFomLocalCoordinates
import android.zero.studio.ui.colorpicker.util.calculateDistanceFromCenter
 ...
 *
 * @param hue is in [0f..360f] of HSL color. Touching any point in ring returns angle between touch
 *   point and center
...
fun SelectorRingHue(
  ...
  BoxWithConstraints(modifier) {
    ...
    val borderStrokeWidthPx = (borderStrokeWidth.value * density).coerceAtMost(radiusInner * .2f)
