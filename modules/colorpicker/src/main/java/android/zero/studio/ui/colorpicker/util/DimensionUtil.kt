package android.zero.studio.ui.colorpicker.util
...
/**
 * Get angle between 0 and 360 degrees from local coordinate system of a composable Local
 * coordinates of touch are equal to Composable position when in bounds, when touch position is
 * above this composable it returns minus in y axis.
 */
...
/**
 * Calculate touch position based on distance to center and angle relative to center
 * counter-clockwise.
 *
 ...
 */
fun calculatePositionFromAngleAndDistance(center: Offset, distance: Float, angle: Float): Offset {
