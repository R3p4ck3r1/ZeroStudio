package android.zero.studio.ui.colorpicker.slider
...
import android.zero.studio.ui.colorpicker.ui.Grey400
...
*/
/**
 * Composable that shows a title as initial letter, title color and a Slider to select [hue] in
...
fun SliderDisplayHueHSV(
  ...
  TitledSliderDisplay(modifier = modifier, title = "Hue", description = "${hue.toInt()}°") {
    SliderHueHSL(
        hue = hue,
...
/**
 * Composable that shows a title as initial letter, title color and a Slider to select [saturation]
 * in [HSV](https://en.wikipedia.org/wiki/HSL_and_HSV) color model.
 *
 * @param hue in [0..360f]
 * @param saturation in [0..1f]
 * @param value in [0..1f]
...
/**
 * Composable that shows a title as initial letter, title color and a Slider to select [value] in
 * [HSV](https://en.wikipedia.org/wiki/HSL_and_HSV) color model.
 *
 * @param hue in [0..360f]
 * @param value in [0..1f]
...
/**
 * Composable that shows a title as initial letter, title color and a Slider to select [alpha] in
 * [HSV](https://en.wikipedia.org/wiki/HSL_and_HSV) color model.
 *
 * @param hue in [0..360f]
 * @param alpha in [0..1f]
...
fun SliderDisplayAlphaHSV(
  ...
  TitledSliderDisplay(
    ...
    SliderAlphaHSV(hue = hue, alpha = alpha, onValueChange = onValueChange)
  }
}
...
/**
 * Composable that shows a title as initial letter, title color and a Slider to select [saturation]
 * in [HSL](https://en.wikipedia.org/wiki/HSL_and_HSV) color model.
 *
 * @param hue in [0..360f]
 * @param saturation in [0..1f]
 * @param lightness in [0..1f]
...
/**
 * Composable that shows a title as initial letter, title color and a Slider to select [lightness]
 * in [HSL](https://en.wikipedia.org/wiki/HSL_and_HSV) color model.
 *
 * @param lightness in [0..1f]
...
fun SliderDisplayLightnessHSL(
  ...
  TitledSliderDisplay(
    ...
    SliderLightnessHSL(lightness = lightness, onValueChange = onValueChange)
  }
}
...
/**
 * Composable that shows a title as initial letter, title color and a Slider to select [red] in
...
fun SliderDisplayRedRGB(
  ...
  TitledSliderDisplay(
    ...
    SliderRedRGB(red = red, onValueChange = onValueChange)
  }
}

/**
 * Composable that shows a title as initial letter, title color and a Slider to select [green] in
 * [RGB](https://en.wikipedia.org/wiki/RGB_color_model) color model.
 *
 * @param green in [0..1f]
...
fun SliderDisplayGreenRGB(
  ...
  TitledSliderDisplay(
    ...
    SliderGreenRGB(green = green, onValueChange = onValueChange)
  }
}

/**
 * Composable that shows a title as initial letter, title color and a Slider to select [blue] in
 * [RGB](https://en.wikipedia.org/wiki/RGB_color_model) color model.
 *
 * @param blue in [0..1f]
...
fun SliderDisplayBlueRGB(
  ...
  TitledSliderDisplay(
    ...
    SliderBlueRGB(blue = blue, onValueChange = onValueChange)
  }
}
