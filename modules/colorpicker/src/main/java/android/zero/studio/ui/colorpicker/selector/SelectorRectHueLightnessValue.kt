package android.zero.studio.ui.colorpicker.selector
...
import android.zero.studio.ui.colorpicker.ui.brush.transparentToBlackVerticalGradient
import android.zero.studio.ui.colorpicker.ui.brush.transparentToGrayVerticalGradient
import android.zero.studio.ui.colorpicker.ui.brush.transparentToWhiteVerticalGradient
import android.zero.studio.ui.colorpicker.ui.brush.whiteToTransparentToBlackHorizontalGradient
import android.zero.studio.ui.colorpicker.ui.brush.whiteToTransparentToBlackVerticalGradient
import android.zero.studio.ui.colorpicker.ui.gradientColorScaleHSL
import android.zero.studio.ui.colorpicker.ui.gradientColorScaleHSV
import com.smarttoolfactory.gesture.detectMotionEvents

/**
 * Rectangle Hue and Value selector for [HSV](https://en.wikipedia.org/wiki/HSL_and_HSV) color model
 *
...
fun SelectorRectHueValueHSV(
  ...
  val transparentToBlackGradient = remember { transparentToBlackVerticalGradient() }
...
/**
 * Rectangle Hue and Saturation selector for [HSV](https://en.wikipedia.org/wiki/HSL_and_HSV) color
 * model
 *
 * @param hue is in [0f..360f] of HSV color
...
fun SelectorRectHueSaturationHSV(
  ...
  val transparentToWhiteGradient = remember { transparentToWhiteVerticalGradient() }
  ...
  SelectorRect(
      ...
      selectorType = selectorType,
      onChange = { h, p -> onChange(h, 1 - p) },
  )
}

/**
 * Rectangle Hue and Saturation selector for [HSL](https://en.wikipedia.org/wiki/HSL_and_HSV) color
 * model
 *
...
fun SelectorRectHueSaturationHSL(
  ...
  val transparentToGrayGradient = remember { transparentToGrayVerticalGradient() }
...
/**
 * Rectangle Hue and Lightness selector for [HSL](https://en.wikipedia.org/wiki/HSL_and_HSV) color
 * model
 *
 * @param hue is in [0f..360f] of HSL color
...
fun SelectorRectHueLightnessHSL(
  ...
  val transitionGradient = remember { whiteToTransparentToBlackVerticalGradient() }
...
fun SelectorRectHueLightnessHSLHorizontal(
  ...
  val transitionGradient = remember { whiteToTransparentToBlackHorizontalGradient() }
 ...
 * @param brushProperty transparent layer above [brushHue] that determines whether this is a value,
 *   saturation or lightness selector for specified [selectorType]
 * @param selectorType is one of the 4 selections of Hue-Saturation or Hue-Lightness for HSL or
 *   Hue-Saturation or Hue-Value for HSV
