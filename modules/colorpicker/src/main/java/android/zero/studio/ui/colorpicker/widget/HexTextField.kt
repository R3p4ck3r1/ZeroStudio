package android.zero.studio.ui.colorpicker.widget
...
import android.zero.studio.ui.colorpicker.ui.Red400
import android.zero.studio.ui.colorpicker.util.HexVisualTransformation
import android.zero.studio.ui.colorpicker.util.hexRegex
import android.zero.studio.ui.colorpicker.util.hexRegexSingleChar
import android.zero.studio.ui.colorpicker.util.hexWithAlphaRegex
...
fun HexTextField(
    ...
    label: @Composable () -> Unit = { Text("Hex", color = Grey400) },
    placeholder: @Composable () -> Unit = { Text("Enter a color", fontSize = textStyle.fontSize) },
  ...
  OutlinedTextField(
      modifier =
          modifier.widthIn(min = 80.dp).drawBehind {
            drawLine(
