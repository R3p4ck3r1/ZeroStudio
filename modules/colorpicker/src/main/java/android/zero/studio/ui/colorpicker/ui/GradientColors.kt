...
fun gradientColorScaleHSV(saturation: Float = 1f, value: Float = 1f, alpha: Float = 1f) =
    listOf(
...
fun gradientColorScaleHSVReversed(saturation: Float = 1f, value: Float = 1f, alpha: Float = 1f) =
    listOf(
        Color.hsv(hue = 360f, saturation = saturation, value = value, alpha = alpha),
        Color.hsv(hue = 300f, saturation = saturation, value = value, alpha = alpha),
        Color.hsv(hue = 240f, saturation = saturation, value = value, alpha = alpha),
...
fun gradientColorScaleHSL(saturation: Float = 1f, lightness: Float = .5f, alpha: Float = 1f) =
    listOf(
