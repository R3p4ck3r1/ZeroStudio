package com.example.responsiveactivitykt.ui.reflow
...
import com.example.responsiveactivitykt.databinding.FragmentReflowBinding
...
class ReflowFragment : Fragment() {
  ...
  override fun onCreateView(
    ...
    reflowViewModel.text.observe(viewLifecycleOwner) { textView.text = it }
    return root
  }
