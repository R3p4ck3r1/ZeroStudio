package com.example.emptywearappwithtileandcomplicationkt.tile
...
import com.example.emptywearappwithtileandcomplicationkt.R
...
fun tilePreview(context: Context) = TilePreviewData(::resources) { tile(it, context) }
