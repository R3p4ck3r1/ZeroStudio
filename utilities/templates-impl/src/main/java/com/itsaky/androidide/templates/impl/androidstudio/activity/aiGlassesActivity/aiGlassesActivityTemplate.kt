...
fun aiGlassesActivityProject(): ProjectTemplate = baseProjectImpl(language = aiGlassesLanguageParameter(), projectVersionData = ProjectVersionData(kotlin = composeKotlinVersion)) {
