...
sourceSets {
  main {
    proto {
      ...
      // REAPI protos are generated by :tooling:reapi-proto. Keep this module
      // limited to its own service definitions so both projects do not publish
      // the same build.bazel.* classes into the app dex.
...
dependencies {
  ...
  protobuf(projects.tooling.reapiProto)
