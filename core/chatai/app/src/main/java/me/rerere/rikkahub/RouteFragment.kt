...
class RouteFragment : Fragment() {
    ...
    private fun ShareHandler(backStack: MutableList<NavKey>) {
        val shareIntent = remember {
            Intent().apply {
                ...
                putExtra(Intent.EXTRA_PROCESS_TEXT, activity?.intent?.getCharSequenceExtra(Intent.EXTRA_PROCESS_TEXT))
            }
        }
    ...
    fun AppRoutes() {
        ...
        SideEffect { (activity as? RouteActivity)?.registerConversationNavigator { id -> backStack.add(Screen.Chat(id)) } }
