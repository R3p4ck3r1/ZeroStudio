...
object FileUtil {
  ...
  private fun getDataColumn(uri: Uri?, selection: String?, selectionArgs: Array<String>?): String? {
    val column = MediaStore.Images.Media.DATA // Column name of the data column to be retrieved
    ...
    try {
      ...
      if (cursor != null && cursor.moveToFirst()) {
        val column_index = cursor.getColumnIndexOrThrow(column) // Get the index of the data column
